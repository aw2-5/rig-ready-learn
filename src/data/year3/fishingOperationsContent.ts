  ...
  days: [
    {
      ...
      content: {
        ar: {
          title: 'عمليات الصيد - المفاهيم الأساسية وأنواع الأسماك',
          explanation: `<section>
<h2 style="color: #1e3a5f; font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">🔷 مقدمة في عمليات الصيد</h2>
...
<strong>عمليات الصيد (Fishing Operations)</strong> هي العمليات التي تُجرى لاسترداد الأجسام الغريبة أو المعدات المفقودة من داخل البئر. تعتبر من أكثر العمليات تعقيداً وتكلفة في صناعة الحفر، وتتطلب خبرة عالية ومعدات متخصصة.
</p>
</div>

<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 ما هي "السمكة" (Fish)؟</h3>

<p style="margin-bottom: 1rem; line-height: 1.8;">
في مصطلحات الحفر، <strong>السمكة (Fish)</strong> هي أي جسم أو قطعة من المعدات تُفقد أو تنفصل داخل البئر ويجب استردادها أو تجاوزها للاستمرار في العمليات. قد تكون السمكة جزءاً من أنبوب الحفر، أداة، أو أي جسم غريب آخر.
</p>

<div style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px; border-right: 4px solid #1e3a5f; margin: 1.5rem 0;">
<h4 style="color: #1e3a5f; margin-bottom: 1rem;">أمثلة على الأسماك الشائعة:</h4>
...
<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 أسباب حدوث عمليات الصيد</h3>
...
<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 تصنيف الأسماك حسب النوع</h3>

<div style="background: #e8f4fd; padding: 1.5rem; border-radius: 10px; margin-bottom: 1.5rem;">
<table style="width: 100%; border-collapse: collapse;">
<thead>
<tr style="background: #1e3a5f; color: white;">
<th style="padding: 0.75rem; text-align: right; border-radius: 8px 0 0 0;">نوع السمكة</th>
...
<strong>💰 التأثير المالي:</strong> عمليات الصيد يمكن أن تكلف من عشرات الآلاف إلى ملايين الدولارات حسب:
</p>
<ul style="margin: 0; padding-right: 1.25rem;">
...
الوقاية من مشاكل الصيد أقل تكلفة بكثير من حلها. الفحص الدوري للمعدات واتباع إجراءات التشغيل الصحيحة يقللان من احتمالية حدوث هذه المشاكل بشكل كبير.
</p>
</div>

</section>`,
          keyTerms: [
            { term: 'السمكة (Fish)', definition: 'أي جسم أو معدات مفقودة داخل البئر تحتاج للاسترداد' },
            { term: 'عمليات الصيد (Fishing)', definition: 'العمليات المتخصصة لاسترداد الأجسام المفقودة من البئر' },
            { term: 'إجهاد المعدن (Metal Fatigue)', definition: 'ضعف المعدن نتيجة الإجهاد المتكرر' },
            { term: 'النفايات المعدنية (Junk)', definition: 'الأجسام المعدنية الصغيرة المفقودة في البئر' },
          ],
          practiceQuestion: {
