...
Preventing fishing problems is far less expensive than solving them. Regular equipment inspection and following correct operating procedures significantly reduce the likelihood of these problems occurring.
    ...
    },
    {
      ...
      content: {
        ar: {
          title: 'أدوات الاسترداد الرئيسية - الماسكات والمغناطيسات',
          explanation: `<section>
<h2 style="color: #1e3a5f; font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">🔷 أدوات الاسترداد للمعدات الأنبوبية المفقودة</h2>

<p style="margin-bottom: 1rem; line-height: 1.8;">
تتنوع أدوات الاسترداد حسب نوع الجسم المستهدف (Fish) المراد استرداده. سنتناول في هذا اليوم الأدوات الرئيسية المستخدمة لاسترداد المعدات الأنبوبية المفقودة والأجسام المعدنية الصغيرة.
</p>
...
<strong>الأوفرشوت (Overshot)</strong> هو أداة استرداد تُستخدم لانتشال المعدات الأنبوبية المفقودة عن طريق الإمساك بها من الخارج. يتكون من:
</p>
...
<p>الجزء الذي يمسك بالجسم المستهدف (Fish) - له أسنان مائلة تسمح بالدخول وتمنع الخروج</p>
</div>

<div style="background: white; padding: 1rem; border-radius: 8px; border: 1px solid #e2e8f0;">
<h4 style="color: #1e3a5f;">3. الدليل (Guide)</h4>
<p>يوجه الأداة للدخول على الجسم المستهدف بشكل صحيح</p>
</div>
...
<p style="margin-bottom: 1rem;">
<strong>السبير (Spear)</strong> هو أداة استرداد تدخل داخل المعدات الأنبوبية المفقودة وتمسكها من الداخل. يُستخدم عندما لا يمكن الوصول للجزء الخارجي من الجسم المستهدف (Fish).
</p>

<h4 style="color: #276749; margin-bottom: 0.75rem;">مكونات السبير:</h4>
<ul style="margin: 0; padding-right: 1.25rem;">
<li><strong>المخروط (Mandrel):</strong> الجزء الذي يدخل داخل الجسم المستهدف</li>
<li><strong>الشرائح (Slips):</strong> تتمدد للإمساك بالجدار الداخلي</li>
<li><strong>آلية التحرير:</strong> للتحرر من الجسم المستهدف عند الحاجة</li>
</ul>
</div>

<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 أدوات استرداد الأجسام الصغيرة (Junk Retrieval)</h3>

<div style="display: grid; gap: 1rem; margin-bottom: 1.5rem;">

<div style="background: #fff5f5; padding: 1.25rem; border-radius: 10px;">
<h4 style="color: #c53030; margin-bottom: 0.75rem;">🧲 مغناطيس الاسترداد (Fishing Magnet)</h4>
...
<h4 style="color: #c05621; margin-bottom: 0.75rem;">🧺 سلة الاسترداد (Junk Basket)</h4>
...
<p>تُنزل لأخذ انطباع عن شكل الجسم المستهدف (Fish) قبل اختيار أداة الاسترداد المناسبة</p>
<ul style="margin-top: 0.5rem; padding-right: 1rem;">
<li>مصنوعة من الرصاص أو الألومنيوم</li>
<li>تعطي صورة واضحة عن حالة رأس الجسم المستهدف</li>
</ul>
</div>

</div>

<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 اختيار أداة الاسترداد المناسبة</h3>

<div style="background: linear-gradient(135deg, #1e3a5f 0%, #2d5a87 100%); color: white; padding: 1.5rem; border-radius: 12px; margin-bottom: 1.5rem;">
<p style="margin-bottom: 1rem;">يعتمد الاختيار على:</p>
<ol style="margin: 0; padding-right: 1.25rem;">
<li style="margin-bottom: 0.5rem;"><strong>حجم الجسم المستهدف (Fish):</strong> القطر الداخلي والخارجي</li>
<li style="margin-bottom: 0.5rem;"><strong>نوع الجسم المستهدف:</strong> أنبوبي، صلب، أو سلكي</li>
<li style="margin-bottom: 0.5rem;"><strong>حالة رأس الجسم المستهدف:</strong> سليم، تالف، أو مشوه</li>
<li style="margin-bottom: 0.5rem;"><strong>عمق الجسم المستهدف:</strong> يؤثر على القوة المطلوبة</li>
...
<p style="margin: 0; color: #856404;">
قبل إنزال أي أداة استرداد، يجب دائماً إنزال أداة الانطباع (Impression Block) لتحديد حالة رأس الجسم المستهدف واختيار الأداة المناسبة بدقة.
</p>
</div>

</section>`,
          keyTerms: [
            { term: 'الأوفرشوت (Overshot)', definition: 'أداة استرداد تمسك بالجسم المستهدف من الخارج' },
            { term: 'السبير (Spear)', definition: 'أداة استرداد تدخل وتمسك بالجسم المستهدف من الداخل' },
            { term: 'السلة (Grapple)', definition: 'الجزء من الأوفرشوت الذي يمسك بالجسم المستهدف' },
            { term: 'أداة الانطباع (Impression Block)', definition: 'أداة لأخذ انطباع عن شكل رأس الجسم المستهدف (Fish)' },
            { term: 'مغناطيس الاسترداد (Fishing Magnet)', definition: 'يجذب الأجسام المعدنية الصغيرة من البئر' },
          ],
          practiceQuestion: {
            question: 'متى يُفضل استخدام السبير (Spear) بدلاً من الأوفرشوت (Overshot)؟',
            options: [
              'عندما يكون الجسم المستهدف صغيراً جداً',
              'عندما لا يمكن الوصول للجزء الخارجي من الجسم المستهدف',
              'عندما يكون الجسم المستهدف غير معدني',
...
Before running any fishing tool, always run an Impression Block to determine the fish top condition and accurately select the appropriate tool.
    ...
    },
    {
      ...
      content: {
        ar: {
          title: 'أدوات الاسترداد المتقدمة - الجارات والقاطعات',
          explanation: `<section>
<h2 style="color: #1e3a5f; font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">🔷 أدوات تحرير المعدات المنحشرة</h2>

<p style="margin-bottom: 1rem; line-height: 1.8;">
عندما تكون المعدات المفقودة (Fish) منحشرة بشدة ولا يمكن سحبها مباشرة، تُستخدم أدوات متخصصة لتحريرها أو قطعها. هذه الأدوات تتطلب خبرة عالية في التشغيل.
</p>
...
<div style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px; margin-bottom: 1.5rem;">
<p style="margin-bottom: 1rem;">
<strong>الجار (Jar)</strong> هو أداة تُولد ضربات قوية (صدمات) للأعلى أو للأسفل لتحرير المعدات المنحشرة. تعمل على مبدأ تراكم الطاقة ثم إطلاقها بشكل مفاجئ.
</p>
...
<p style="margin-bottom: 1rem; line-height: 1.8;">
عندما يفشل تحرير المعدات المفقودة (Fish)، قد يكون القطع هو الحل الوحيد لتقليل الخسائر واسترداد أكبر قدر ممكن من المعدات.
</p>
...
<p>تُستخدم لطحن الجسم المستهدف (Fish) إلى قطع صغيرة يمكن تدويرها للسطح مع سائل الحفر</p>
</div>

<div style="margin-bottom: 1rem;">
<h4 style="color: #1e3a5f;">مطحنة الحطام (Junk Mill)</h4>
<p>تطحن الأجسام الصلبة مثل رؤوس الحفر المكسورة</p>
</div>

<div>
<h4 style="color: #1e3a5f;">مطحنة التوجيه (Pilot Mill)</h4>
<p>تُستخدم للدخول على الجسم المستهدف وتوسيطه قبل عملية الاسترداد</p>
</div>
...
<p style="margin: 0; color: #856404;">
قرار قطع المعدات المفقودة (Fish) يُتخذ بعد فشل جميع محاولات التحرير. يجب حساب التكلفة والوقت بدقة، فأحياناً يكون ترك جزء من المعدات في البئر (Sidetrack) أقل تكلفة من محاولات الاسترداد المتكررة.
</p>
</div>

</section>`,
          keyTerms: [
            { term: 'الجار (Jar)', definition: 'أداة تولد ضربات قوية لتحرير المعدات المنحشرة' },
            ...
            { term: 'المطحنة (Mill)', definition: 'تطحن الجسم المستهدف (Fish) إلى قطع صغيرة' },
            { term: 'جار الانزلاق (Bumper Sub)', definition: 'جار يوفر ضربات للأسفل' },
          ],
          practiceQuestion: {
            question: 'ما هي وظيفة مسرع الجار (Jar Accelerator)؟',
            options: [
              'قطع المعدات المنحشرة',
              'تخزين وإطلاق طاقة إضافية لزيادة قوة الضربة',
              'توجيه الجار نحو الجسم المستهدف',
...
The decision to cut the fish is made after all freeing attempts fail. Cost and time must be calculated precisely, as sometimes leaving part of the fish in the well (Sidetrack) is less costly than repeated recovery attempts.
    ...
    },
    {
      ...
      content: {
        ar: {
          title: 'تخطيط وتنفيذ عمليات الاسترداد',
          explanation: `<section>
<h2 style="color: #1e3a5f; font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">🔷 خطوات التخطيط لعملية الاسترداد</h2>

<p style="margin-bottom: 1rem; line-height: 1.8;">
النجاح في عمليات الاسترداد (Fishing Operations) يعتمد بشكل كبير على التخطيط الدقيق وجمع المعلومات الكافية قبل البدء. كل دقيقة من التخطيط توفر ساعات من العمل غير المثمر.
</p>
...
<h4 style="color: #1e3a5f; margin-bottom: 0.5rem;">1. معلومات الجسم المستهدف (Fish)</h4>
<ul style="margin: 0; padding-right: 1rem;">
...
<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 المرحلة الثانية: تحديد حالة الجسم المستهدف (Fish)</h3>
...
<p>لأخذ انطباع عن شكل رأس الجسم المستهدف وحالته</p>
</li>
<li style="margin-bottom: 1rem;">
...
<p>التأكد من العمق الفعلي للجسم المستهدف</p>
</li>
<li>
<strong>تقييم حالة الثقب:</strong>
<p>هل هناك انهيارات أو تضيقات فوق الجسم المستهدف؟</p>
</li>
</ol>
</div>

<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 المرحلة الثالثة: اختيار استراتيجية الاسترداد</h3>

<div style="display: grid; gap: 1rem; margin-bottom: 1.5rem;">

<div style="background: #f0fff4; padding: 1.25rem; border-radius: 10px;">
<h4 style="color: #276749; margin-bottom: 0.75rem;">🔄 استراتيجية 1: الاسترداد المباشر</h4>
<p>إذا كانت المعدات المفقودة حرة أو منحشرة بشكل خفيف:</p>
<ul style="margin-top: 0.5rem; padding-right: 1rem;">
...
<ul style="margin-top: 0.5rem; padding-right: 1rem;">
<li>قطع المعدات المفقودة فوق نقطة الانحشار</li>
...
<ul style="margin-top: 0.5rem; padding-right: 1rem;">
<li>حفر مسار جانبي حول المعدات المفقودة</li>
<li>يُستخدم عندما يكون الجسم المستهدف (Fish) عميقاً جداً</li>
...
<p style="margin: 0; color: #856404;">
توضع دائماً فوق أداة الاسترداد مباشرة. تسمح بفصل تجميعة الاسترداد من الجسم المستهدف (Fish) في حالة فشل العملية، لتجنب فقدان التجميعة كاملة.
</p>
</div>

</section>`,
          keyTerms: [
            { term: 'تجميعة الاسترداد (Fishing BHA)', definition: 'مجموعة الأدوات المستخدمة في عملية الاسترداد' },
            { term: 'وصلة الأمان (Safety Joint)', definition: 'تسمح بفصل التجميعة في حالة الفشل' },
            { term: 'الانحراف (Sidetrack)', definition: 'حفر مسار جانبي حول المعدات المفقودة' },
            { term: 'الضرب (Jarring)', definition: 'تطبيق ضربات لتحرير المعدات المنحشرة' },
          ],
          practiceQuestion: {
            question: 'ما هي الخطوة الأولى قبل اختيار أداة الاسترداد المناسبة؟',
            options: [
              'البدء مباشرة بالسحب',
              'إنزال أداة الانطباع لتحديد حالة رأس الجسم المستهدف (Fish)',
              'قطع المعدات المفقودة',
              'حفر مسار جانبي'
            ],
            correctAnswer: 1,
          },
...
Always placed directly above the fishing tool. It allows separation of the fishing assembly from the fish in case of operation failure, to avoid losing the entire assembly.
    ...
    },
    {
      ...
      content: {
        ar: {
          title: 'مراجعة شاملة - عمليات الاسترداد (Fishing)',
          explanation: `<section>
<h2 style="color: #1e3a5f; font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">🔷 ملخص الأسبوع: عمليات الاسترداد (Fishing Operations)</h2>

<div style="background: linear-gradient(135deg, #1e3a5f 0%, #2d5a87 100%); color: white; padding: 1.5rem; border-radius: 12px; margin-bottom: 1.5rem;">
<p style="font-size: 1.1rem;">
راجعنا خلال هذا الأسبوع كل ما يتعلق بعمليات الاسترداد من المفاهيم الأساسية إلى التخطيط والتنفيذ. إليك ملخصاً شاملاً للنقاط الرئيسية.
</p>
</div>
...
<ul style="margin: 0; padding-right: 1.25rem;">
<li><strong>الجسم المستهدف (Fish):</strong> أي معدات مفقودة داخل البئر تحتاج للاسترداد</li>
<li><strong>أسباب الاسترداد:</strong> ميكانيكية، تشغيلية، جيولوجية</li>
<li><strong>أنواع الأجسام المستهدفة:</strong> أنبوبية، صلبة، سلكية، حطام معدني</li>
<li><strong>التأثير الاقتصادي:</strong> قد تكلف ملايين الدولارات</li>
</ul>
</div>

<h3 style="color: #e67e22; font-size: 1.25rem; font-weight: bold; margin: 1.5rem 0 1rem 0;">📌 اليوم الثاني: أدوات الاسترداد الرئيسية</h3>
...
<td style="padding: 0.5rem;">يحدد حالة رأس الجسم المستهدف</td>
</tr>
</table>
</div>
...
<ol style="margin: 0; padding-right: 1.25rem;">
<li style="margin-bottom: 0.5rem;"><strong>جمع المعلومات:</strong> عن الجسم المستهدف والبئر وظروف الانحشار</li>
...
<li><strong>تصميم تجميعة الاسترداد:</strong> مع وصلة الأمان</li>
</ol>
</div>
...
<p style="margin: 0;"><strong>⚠️ دائماً:</strong> استخدم Impression Block قبل اختيار أداة الاسترداد</p>
</div>

<div style="background: #fff5f5; padding: 1rem; border-radius: 8px; border-right: 4px solid #c53030;">
<p style="margin: 0;"><strong>⚠️ دائماً:</strong> ضع Safety Joint فوق أداة الاسترداد</p>
</div>

<div style="background: #fff5f5; padding: 1rem; border-radius: 8px; border-right: 4px solid #c53030;">
<p style="margin: 0;"><strong>⚠️ لا تنسَ:</strong> الوقاية أفضل من العلاج - الفحص الدوري يمنع مشاكل فقدان المعدات</p>
</div>
...
Tomorrow there will be a comprehensive 10-question test covering all topics from this week. Review the concepts and terminology well!
    ...
    },
    {
      ...
      content: {
        ar: {
          title: 'اختبار عمليات الاسترداد (Fishing)',
          explanation: 'اختبار شامل من 10 أسئلة حول عمليات الاسترداد',
          keyTerms: [],
        },
        en: {
      ...
      quiz: {
        ar: [
          {
            question: 'ما هو التعريف الصحيح للجسم المستهدف (Fish) في عمليات الحفر؟',
            options: ['نوع من سوائل الحفر', 'أي معدات مفقودة داخل البئر تحتاج للاسترداد', 'أداة لقياس عمق البئر', 'نوع من التكوينات الصخرية'],
            correctAnswer: 1
          },
          {
            question: 'أي أداة تُستخدم لأخذ انطباع عن شكل رأس الجسم المستهدف (Fish)؟',
          ...
          },
          {
            ...
            options: ['قطع المعدات المفقودة', 'زيادة قوة ضربة الجار', 'توجيه أداة الاسترداد', 'تنظيف البئر'],
            correctAnswer: 1
          },
          {
            question: 'أين توضع وصلة الأمان (Safety Joint) في تجميعة الاسترداد؟',
            options: ['في أعلى التجميعة', 'فوق أداة الاسترداد مباشرة', 'تحت الجار', 'في منتصف أنابيب الحفر'],
            correctAnswer: 1
          },
          {
            question: 'ما هو الخيار الأفضل عندما تفشل جميع محاولات استرداد المعدات المفقودة؟',
            options: ['الاستمرار في الضرب لأيام', 'Sidetrack أو طحن المعدات', 'ترك البئر', 'زيادة كثافة سائل الحفر'],
            correctAnswer: 1
          },
          {
          ...
          {
            question: 'ما هي أداة الاسترداد المناسبة لانتشال الأجسام الحديدية الصغيرة؟',
          ...
          {
            question: 'لماذا يُنصح بإنزال Impression Block قبل عملية الاسترداد؟',
            options: ['لتنظيف رأس الجسم المستهدف', 'لتحديد حالة رأس الجسم المستهدف واختيار الأداة المناسبة', 'لقطع المعدات المفقودة', 'لزيادة الوزن على المعدات'],
            correctAnswer: 1
          }
        ],
        en: [
